    ...
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 bg-[#1A1F2C]/80 backdrop-blur-lg">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <a href="/latest-deployments" className="text-white/80 hover:text-white transition-colors">{t.nav.products}</a>
          <a href="/solutions" className="text-white/80 hover:text-white transition-colors">{t.nav.industries}</a>
